...
<body class="account-page">
	...
	<div class="main-wrapper">
		...
		<?php $query = "SELECT * FROM users,user_profile where users.user_profile_id=user_profile.user_profile_id and users.user_id=" . $_SESSION["user_id"] ;
		$result = $conn->query($query);
		if ($result->num_rows > 0) {
			if ($row = $result->fetch_assoc()) {
						...
						<div class="doctor-widget">
							<div class="doc-info-left">
								...
								<div class="doc-info-cont">
									...
									<h4 class="doc-name">Dr.' . ucfirst($row["first_name"]) . ' ' . ucfirst($row["last_name"]) . ' </h4>
									<p class="doc-speciality"> ' . ucfirst($row["specialities"]) .' </p>
								<div class="rating">
									...
									<div class="clinic-details">
										<p class="doc-location"><i class="fas fa-map-marker-alt"></i> '. ucfirst($row["city"]).', ' . ucfirst($row["country"]) . ' <a href="javascript:void(0);">Get Directions</a></p>
									</div>
								</div>
							</div>
							...
							<div class="clini-infos">
								<ul>
									...
									<li><i class="far fa-money-bill-alt"></i> ' . ucfirst($row["cost"]) . '</li>
								</ul>
							</div>
